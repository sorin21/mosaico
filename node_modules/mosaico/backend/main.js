...
app.get('/mosaico/node_modules/mosaico/uploads', function(req, res) {
...
console.log(req.query.method);
  if (req.query.method == 'placeholder') {
    ...
    var size = 40;
        ...
        var ic = gm(req.query.src); //src = http://127.0.0.1:9006/uploads/8d76d739735ef83bc369f46fcc715cc8854b1bba17760f0553be1a2b4cb3329c (8).jpg
